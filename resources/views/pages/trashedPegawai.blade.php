  ...
  <div class="col-md-12 mt-5">
    <div class="card">
      <div class="card-header">
        <h3>Data Pegawai Trash</h3>
      </div>
      <div class="card-body">
      <a href="#" data-action="/pegawai/index"><< Back</a>
        <div class="table-responsive">
          <table style="width: 100%;" id="tabPegawai" data-action="/pegawai/table" class="table table-md table-hover table-striped table-bordered">
            ...
            <tr>
              ...
              <td>
                <a href="#" data-action="/pegawai/restore" data-id="{{ $p->nomor_induk }}">Restore</a> || 
                <a href="#" data-action="/pegawai/truedelete" data-id="{{ $p->nomor_induk }}">Permanent Delete</a>
              </td>
            </tr>
            @endforeach
            @else
